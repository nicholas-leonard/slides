...
cmd:text('Example:')
cmd:text("th train-rnnlm.lua -progress -cuda -lstm -seqlen 20 -hiddensize '{200,200}' -batchsize 20 -startlr 1 -cutoff 5 -maxepoch 13 -schedule '{[5]=0.5,[6]=0.25,[7]=0.125,[8]=0.0625,[9]=0.03125,[10]=0.015625,[11]=0.0078125,[12]=0.00390625}'")
cmd:text('Options:')
-- training
...
for i,hiddensize in ipairs(opt.hiddensize) do 
   ...
   if opt.gru then -- 1 Gated Recurrent Units
      rnn = nn.GRU(inputsize, hiddensize, nil, opt.dropout/2)
   elseif opt.lstm then -- 1 Long Short Term Memory units
      require 'nngraph'
